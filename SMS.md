...
Handyman alone:
```
Handyman-only page is $897: https://jimmythegod100.github.io/central-valley-pitch-mockups/mockups/bruces-handyman.html Still recommend the $1,497 bundle if you want both listed.
```
Plumbing alone:
```
Plumbing-only page (license + drain CTA) is $997: https://jimmythegod100.github.io/central-valley-pitch-mockups/mockups/bruces-plumbing.html Bundle with handyman is $1,497.
```
...
```
Hey — just bumping the sample site I sent. Still happy to do the launch package at the price I quoted if you want it live this month. No pressure either way.
```
